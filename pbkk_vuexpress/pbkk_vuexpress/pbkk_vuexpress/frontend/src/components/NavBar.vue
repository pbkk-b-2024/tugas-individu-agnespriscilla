<template>
    <div class="header">
        <router-link @click="scrollToTop()" to="/" class="logo">
            <img src="../assets/images/profile-whismie.png" alt="Whismie Logo" width="100" height="100" />Whismie
        </router-link>
        ...
        <div class="icons">
            ...
            <div v-else class="fas fa-user account" style="background: #d35400;color: white;" @click="showLog">
                <ul class="drop-down-select">
                    <li>
