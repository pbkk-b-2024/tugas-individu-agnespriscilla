                        ...
                        <div class="box">
                            ...
                            <div v-if="!filterFoods.length">
                                <div class="box-content row no-food">
                                    <div class="content">
                                        <h2 style="color: #8e44ad;">You do not have any items in your cart, go shop
                                            now!</h2>
                                    </div>
                                    <div class="image">
                                        <img src="../assets/images/belumpesan-whismie.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                            <div v-else>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="box">
                            ...
                            <div class="box-content text-center">
                                <h3><i class="fa fa-phone"></i> 0811-3599-155</h3>
                                <span class="small">
