                ...
                <table class="table table-bordered text-center">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="bg-purple activity-time">Discount 10%</div>
                            </td>
                            <td>
                                <div class="bg-purple activity-time">Discount 10%</div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="bg-purple activity-time">Free Drink</div>
                            </td>
                            <td class="bg-light-gray">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="bg-purple activity-time">Discount 5% drink </div>
                            </td>
                            <td class="bg-light-gray">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="bg-purple activity-time">Discount 15%</div>
                            </td>
                            <td>
                                <div class="bg-purple activity-time">Discount 15%</div>
                            </td>
